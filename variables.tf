...
variable "load_test_tag" {
  description = "Load-test run identifier applied as the LoadTestTag tag on the app_data S3 bucket. Set per load-test run; leave empty for normal deployments."
  type        = string
  default     = ""
}
