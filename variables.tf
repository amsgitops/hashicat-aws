...
variable "sns_codekeeper_alerts_display_name" {
  description = "Display name for the codekeeper-test-alerts SNS topic (used as the SMS sender name)."
  default     = "GetTest 1778651191"
}
